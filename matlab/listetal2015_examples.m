...
[example1] = listetal2015(B,Y,sub,D,combo,select)
...
numpc = size(combo,1);                         % the number of pairs of treatment (control) groups of interest
select = ones(numoc,numsub,numpc);             % We are interested in all the numoc*numsub*numpc hypotheses.
[example2] = listetal2015(B,Y,sub,D,combo,select)
...
numpc = size(combo,1);                         % the number of pairs of treatment (control) groups of interest
select = ones(numoc,numsub,numpc);             % We are interested in all the numoc*numsub*numpc hypotheses.
[example4] = listetal2015(B,Y,sub,D,combo,select)
...
numpc = size(combo,1);                         % the number of pairs of treatment (control) groups of interest
select = ones(numoc,numsub,numpc);             % We are interested in all the numoc*numsub*numpc hypotheses.
[example5] = listetal2015(B,Y,sub,D,combo,select)
